...
@section('content')
    ...
    <div class="d-flex justify-content-between">
        ...
        <a href="{{ route('artists.create') }}" class="btn btn-primary my-3" title="create artist" data-toggle="tooltip" data-placement="top"><i class="fa fa-plus"></i></a>
    </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Artists</h6>
        </div>
        <div class="card-body">
                                ...
                                <thead>
                                    <tr role="row">
                                        <th class="sorting sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1"
                                            ...
                                            aria-label="Name: activate to sort column descending">Artist picture</th>
